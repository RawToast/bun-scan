...
export class NpmAuditClient {
   ...
   */
  async queryVulnerabilities(packages: Bun.Security.Package[]): Promise<NpmAdvisory[]> {
   ...
   */
  private buildRequestPayload(packages: Bun.Security.Package[]): NpmAuditRequest {
   ...
   */
  private async queryInBatches(packages: Bun.Security.Package[]): Promise<NpmAdvisory[]> {
   ...
   */
  private async executeBulkQuery(payload: NpmAuditRequest): Promise<NpmAdvisory[]> {
