...
describe("Version Management", () => {
  ...
  describe("Version in URLs and Paths", () => {
    test("constructs npm package URL with version", () => {
      ...
      expect(url).toBe("https://www.npmjs.com/package/bun-osv-scanner/v/v1.0.1")
    })
    ...
    test("constructs GitHub release URL with version", () => {
      ...
      expect(url).toBe("https://github.com/maloma7/bun-osv-scanner/releases/tag/v1.0.1")
    })
    ...
    test("constructs GitHub blob URL with version", () => {
      ...
      expect(url).toBe("https://github.com/maloma7/bun-osv-scanner/blob/v1.0.1/CHANGELOG.md")
    })
  })
